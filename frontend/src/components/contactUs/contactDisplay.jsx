  ...
  return (
        <div className=''>
            <div className='flex gap-4 p-6'>
                <img src="/images/phone.png" alt="" className='border border-white rounded-full w-16 h-16 mt-1.5 md:w-20 md:h-20' />
             ...
             <div className='flex gap-4 p-6'>
                <img src="/images/chat.png" alt="" className='border border-white rounded-full w-16 h-16 mt-1.5 md:w-20 md:h-20' />
                <div className='block text-white'>
             ...
             <div className='flex gap-4 p-6'>
                <img src="/images/job-form.png" alt="" className='border border-white rounded-full w-16 h-16 mt-1.5 md:w-20 md:h-20' />
                <div className='block text-white'>
             ...
             <div className='flex gap-4 p-6'>
                <img src="/images/location.png" alt="" className='border border-white rounded-full w-16 h-16 mt-1.5 md:w-20 md:h-20' />
                <div className='block text-white'>
