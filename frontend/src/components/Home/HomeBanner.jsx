  ...
  const FirstBanner = ({ image_path, heading, text }) => {
    return (
      <div className='w-[100vw]  '>
        <div
          className='w-full py-5 px-10 md:py-12 h-fit  relative bg-cover md:bg-right bg-no-repeat md:flex md:justify-around  '
          style={{ backgroundImage: `url(/images/${image_path})` }}
        >
          <div className='md:mx-20 flex flex-col md:py-15'>
            <div>
              <span className='w-full    mb-2  text-white text-xl md:text-3xl flex justify-center md:justify-normal font-bold '>
                {heading}
              </span>
            </div>
            <div>
